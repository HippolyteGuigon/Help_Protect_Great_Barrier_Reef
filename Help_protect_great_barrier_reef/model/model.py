...
class yolo_model:
    ...
    def split_files(self)->None:
        ...
        for train_image_path, test_image_path, valid_image_path\
            ...
            shutil.copy(test_image_path.replace(".jpg", ".txt"),  os.path.join(split_path,"train_set"))
            shutil.copy(valid_image_path.replace(".jpg", ".txt"),  os.path.join(split_path,"train_set"))
