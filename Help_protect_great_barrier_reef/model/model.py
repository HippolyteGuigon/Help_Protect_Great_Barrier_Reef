...
class yolo_model:
    ...
    def split_files(self)->None:
        ...
        for test_image_path in tqdm(self.test_images):
            ...
            os.rename(os.path.join(split_path,"test_set",image_name),os.path.join(split_path,"test_set",video_name+"_"+image_name))
            os.rename(os.path.join(split_path,"test_set",image_name.replace(".jpg", ".txt")),os.path.join(split_path,"test_set",video_name+"_"+image_name.replace(".jpg", ".txt")))
        ...
        for valid_image_path in tqdm(self.val_images):
            ...
            os.rename(os.path.join(split_path,"valid_set",image_name),os.path.join(split_path,"valid_set",video_name+"_"+image_name))
            os.rename(os.path.join(split_path,"valid_set",image_name.replace(".jpg", ".txt")),os.path.join(split_path,video_name+"_"+image_name.replace(".jpg", ".txt")))
        ...
        for train_image_path in tqdm(self.train_images):
            ...
            os.rename(os.path.join(split_path,"train_set",image_name),os.path.join(split_path,"train_set",video_name+"_"+image_name))
            os.rename(os.path.join(split_path,"train_set",image_name.replace(".jpg", ".txt")),os.path.join(split_path,video_name+"_"+image_name.replace(".jpg", ".txt")))
